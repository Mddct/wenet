...
def init_dataset(dataset_type,
    ...
    if dataset_type == 'asr':
        return init_asr_dataset(data_type, data_list_file, tokenizer, conf,
                                partition)
    elif dataset_type == 'sound_storm_dataset':
        from wenet.codec.init_dataset import init_dataset as init_soundstorm_dataset
        return init_soundstorm_dataset(data_type, data_list_file, conf,
                                       partition)
    else:
